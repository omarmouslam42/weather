...
function displayWeatherNow(){
    ...
    <div class="card-header ">
        ...
        <div class="card-view news  news1 ps-3 p-4">
            ...
            <div class=" d-flex justify-content-start align-items-center">
                <div class=" d-flex justify-content-center align-items-center">
                    <img class="m-1 mb-3" src="img/icon-umberella.png" alt="icon">
                    <p>20%</p>
                </div>
                <div  class=" d-flex justify-content-center align-items-center mx-3">
                    <img class="m-1 mb-3" src="img/icon-wind.png" alt="icon">
                    <p>18km/h</p>
                </div>
                <div class=" d-flex justify-content-center align-items-center">
                    <img class="m-1 mb-3" src="img/icon-compass.png" alt="icon">
                    <p>East</p>
                </div>
                <div></div>
            </div>
...
async function getCity() {
    let res =await fetch(`https://ipinfo.io/json?token=52a0e48f656e11`);
...
async function getWeather(city) {
    let weatherRes =await fetch(`http://api.weatherapi.com/v1/forecast.json?key=33514ada13f94223baf140010222010&q=${city}&days=3&aqi=no&alerts=no`);
...
document.querySelector(".local").addEventListener("click",()=>{
    if (countryName.value != '') {
        getWeather(countryName.value);
    }
    
})
document.querySelector(".getinput").addEventListener("change",()=>{
    if (countryName.value != undefined) {
        getWeather(countryName.value);
    }
})
